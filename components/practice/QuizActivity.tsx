...
import { X, ChevronRight, CheckCircle2, XCircle, Lightbulb } from 'lucide-react';
import { PracticeActivity, QuizQuestion, QuizOption } from '../../types';
...
const QuizActivity: React.FC<QuizActivityProps> = ({ activity, questions, onComplete, onClose }) => {
          ...
          >
            ...
            <div className="space-y-3">
              {currentQuestion.options.map((option, index) => (
                ...
                >
                  <span className="w-8 h-8 rounded-lg bg-zinc-100 dark:bg-white/10 flex items-center justify-center text-sm font-bold text-zinc-600 dark:text-zinc-300">

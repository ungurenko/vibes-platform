...
const Register: React.FC<RegisterProps> = ({ inviteCode, onRegister, onNavigateLogin, validateInvite }) => {
  ...
  // Ref для хранения timeoutId и cleanup при размонтировании
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Сохраняем timeout в ref для возможности cleanup
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 flex flex-col items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
            ...
            <h1 className="font-display text-2xl font-bold text-zinc-900 dark:text-white">Добро пожаловать в ВАЙБС</h1>

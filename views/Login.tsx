      ...
      >
        ...
        {view === 'login' && (
            <div className="mt-8 text-center text-sm text-zinc-500 dark:text-zinc-400">
                ...
                <a href="#" className="text-violet-600 dark:text-violet-400 font-bold hover:underline">Узнать о курсе ВАЙБС</a>
            </div>
        )}
      </motion.div>
    </div>

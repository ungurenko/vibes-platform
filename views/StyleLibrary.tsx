...
const StyleLibrary: React.FC<StyleLibraryProps> = ({ styles = STYLES_DATA }) => {
  ...
  // Сбрасывать состояние при смене стиля и определять обрезку текста
  useEffect(() => {
                ...
                >
                    ...
                    <div className="w-full md:w-2/5 p-8 md:p-12 flex flex-col bg-white dark:bg-zinc-900 overflow-y-auto">
                        ...
                        <div className="mb-8">
                            ...
                            {(isTextClamped || isDescriptionExpanded) && (
                                <button
                                    onClick={() => setIsDescriptionExpanded(!isDescriptionExpanded)}
                                    className="mt-2 text-sm text-violet-600 dark:text-violet-400 hover:underline font-medium"
                                >
